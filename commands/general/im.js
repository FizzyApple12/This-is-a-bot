...
exports.run = function (bot, msg, args) {
    if (args[1].toLowerCase() == "bored") {
        ...
        messageSanitizer.reply(msg, "Hi Bored, i'm a bot!", {
        ...
        messageSanitizer.reply(msg, "I'm Bored");
        setTimeout(function () { messageSanitizer.sendChannel(msg, "Wait a second..."); }, 1000);
        setTimeout(function () { messageSanitizer.sendChannel(msg, "", { file: "https://media1.tenor.com/images/cbb5332b609d9e1bb484c5dc925a774d/tenor.gif", }); }, 2000);
        ...
        messageSanitizer.reply(msg, "no, i'm the bot around here.");
    }
    run = true;
}
