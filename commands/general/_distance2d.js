...
exports.run = function (bot, msg, args) {
    ...
    try {
        ...
        if (answer) {
            messageUtils.reply(msg, "The distance between points ``" + args[1] + ", " + args[2] + "`` and ``" + args[3] + ", " + args[4] + "`` is ``" + answer + "``");
        } else {
            messageUtils.reply(msg, "Hmmm... ``" + args[1] + ", " + args[2] + "`` and/or ``" + args[3] + ", " + args[4] + "`` do not appear to be valid points...");
        }
    } catch (e) {
        messageUtils.reply(msg, "Hmmm... ``" + args[1] + ", " + args[2] + "`` and/or ``" + args[3] + ", " + args[4] + "`` do not appear to be valid points...");
    }
